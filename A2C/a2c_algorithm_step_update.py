...
class A2C:
    ...
    def __init__(self,
        ...
        if not is_test:
            self.writer = SummaryWriter('./logs_step_update/A2C_{}'.format(self.env_name))
    ...
    def train(self, epochs):
        ...
        for epoch in range(epochs):
            ...
            if (epoch + 1) % self.save_model_frequency == 0:
                save_model(self.critic, 'model_step_update/{}_model/critic_{}'.format(self.env_name, epoch))
                save_model(self.actor, 'model_step_update/{}_model/actor_{}'.format(self.env_name, epoch))
            ...
            if (epoch + 1) % self.eval_frequency == 0:
                ...
                if eval_r > best_eval:
                    best_eval = eval_r
                    save_model(self.critic, 'model_step_update/{}_model/best_critic'.format(self.env_name))
                    save_model(self.actor, 'model_step_update/{}_model/best_actor'.format(self.env_name))
